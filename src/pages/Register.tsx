...
import { ArrowLeft, User, Mail, Lock, CheckCircle, AlertCircle, Phone } from "lucide-react";
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        setError(result.message || "Ocorreu um erro durante o cadastro. Tente novamente mais tarde.");
        toast({
          variant: "destructive",
          title: "Erro no cadastro",
          description: result.message || "Erro ao criar conta. Tente novamente mais tarde."
        });
      }
    } catch (err) {
