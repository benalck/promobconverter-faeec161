...
const Conversor = () => {
  ...
  const allModules = [
    ...
    },
    {
      ...
      description: "Compare dois orçamentos e visualize diferenças de custos",
      icon: Calculator,
      path: "/comparar-orcamentos",
    ...
    },
    {
      ...
      description: "Gerencie templates visuais para seus PDFs",
      icon: FileText,
      path: "/templates-orcamento",
      color: "from-rose-500 to-pink-500",
      isNew: true,
    },
    {
      title: "Gestão de Estoque",
      description: "Gerencie seu estoque de chapas, ferragens e insumos",
      icon: FolderKanban,
      path: "/estoque",
